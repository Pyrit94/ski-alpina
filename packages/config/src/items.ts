...
export const CATALOG: CatalogItem[] = [
  ...
  { id: "hotel5", category: "buildings", name: "Palace ★★★★★", blurb: "240 Betten. Luxus, Spa, enorme Einnahmen.", cost: 140000, gemCost: 80, xp: 150, unlockLevel: 8, buildSeconds: 24, footprint: 1, maxSlope: 0.18, minElev: 1580, maxElev: 2000, beds: 240, color: "#3d2a22" },
  { id: "shop", category: "buildings", name: "Sportshop", blurb: "Ski, Helm, Souvenirs. Bonus auf Zufriedenheit.", cost: 9500, xp: 18, unlockLevel: 2, buildSeconds: 7, footprint: 1, maxSlope: 0.28, minElev: 1580, maxElev: 2400, color: "#2f6f8f" },
  { id: "skischool", category: "buildings", name: "Skischule", blurb: "Mehr Anfaenger, hoehere Auslastung blauer Pisten.", cost: 16000, xp: 28, unlockLevel: 4, buildSeconds: 10, footprint: 1, maxSlope: 0.3, minElev: 1580, maxElev: 2300, color: "#c45c2a" },
  ...
  { id: "lights", category: "deco", name: "Flutlicht", blurb: "Nachtpisten. Verlaengert den Betriebstag.", cost: 9000, xp: 16, unlockLevel: 5, buildSeconds: 6, footprint: 1, maxSlope: 0.5, minElev: 1700, maxElev: 3200, color: "#f4e27a" },
  { id: "snowmaker", category: "services", name: "Beschneiung", blurb: "Haelt die Schneequalitaet hoch.", cost: 20000, xp: 32, unlockLevel: 3, buildSeconds: 8, footprint: 1, maxSlope: 0.5, minElev: 1700, maxElev: 3200, color: "#7ec8ff" },
  { id: "groomer", category: "services", name: "Pistenraupe", blurb: "Depot. Gepflegte Pisten, weniger Stau.", cost: 14000, xp: 22, unlockLevel: 2, buildSeconds: 8, footprint: 1, maxSlope: 0.3, minElev: 1580, maxElev: 2400, color: "#d9890f" },
  { id: "workshop", category: "services", name: "Werkstatt", blurb: "Senkt Unterhalt der Bahnen.", cost: 11000, xp: 18, unlockLevel: 3, buildSeconds: 8, footprint: 1, maxSlope: 0.28, minElev: 1580, maxElev: 2200, color: "#6d6d6d" },
  { id: "parking", category: "services", name: "Parkhaus", blurb: "Tagesgaeste brauchen Parkplaetze.", cost: 8000, xp: 14, unlockLevel: 1, buildSeconds: 6, footprint: 1, maxSlope: 0.18, minElev: 1560, maxElev: 1850, color: "#4a5560" },
  { id: "clinic", category: "services", name: "Bergrettung", blurb: "Sicherheit. Bonus auf schwarze Pisten.", cost: 17000, xp: 26, unlockLevel: 4, buildSeconds: 9, footprint: 1, maxSlope: 0.32, minElev: 1600, maxElev: 3000, color: "#d23b3b" },
  { id: "bus", category: "services", name: "Busbahnhof", blurb: "OeV-Anschluss. Weniger Verkehrsstau.", cost: 12500, xp: 20, unlockLevel: 2, buildSeconds: 8, footprint: 1, maxSlope: 0.2, minElev: 1560, maxElev: 1850, color: "#1f7a4d" },
];
